package net.nightawk.jdbc.basic;
...
public class SphexPoolingDataSource extends PoolingDataSource {
    ...
    public SphexPoolingDataSource(GenericObjectPool connectionPool, String url, List<Interceptor> interceptors) {
    ...
    private class SphexPoolGuardConnectionWrapper extends DelegatingConnection {
        ...
        public PreparedStatement prepareStatement(String sql) throws SQLException {
            checkOpen();
            return new SphexDelegatingPreparedStatement(this, delegate.prepareStatement(sql), sql, url, interceptors);
        }

        public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
            checkOpen();
            return new SphexDelegatingPreparedStatement(this, delegate.prepareStatement(sql, resultSetType, resultSetConcurrency), sql, url, interceptors);
        }
        ...
        public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
            checkOpen();
            return new SphexDelegatingPreparedStatement(this, delegate.prepareStatement(sql, autoGeneratedKeys), sql, url, interceptors);
        }

        public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
            checkOpen();
            return new SphexDelegatingPreparedStatement(this, delegate.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), sql, url, interceptors);
        }

        public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
            checkOpen();
            return new SphexDelegatingPreparedStatement(this, delegate.prepareStatement(sql, columnIndexes), sql, url, interceptors);
        }

        public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
            checkOpen();
            return new SphexDelegatingPreparedStatement(this, delegate.prepareStatement(sql, columnNames), sql, url, interceptors);
        }
